        ...
        private void InitializePalettes()
        {
            DoorSymbols = new DiagramObjectCollection<NodeBase>()
            {
                ...
                new Node()
                {
                    ...
                    Shape = new PathShape()
                    {
                        Data = "M4 4H273V145.749H192.981V250H71.25V110.312H4V4Z"
                    }
                },
                new Node()
                {
                    ...
                    Shape = new PathShape()
                    {
                        Data = "M4 4H273V250H146.5V110.312H4V4Z"
                    }
                },
                new Node()
                {
                ...
                new Node()
                {
                    ...
                    Tooltip= new DiagramTooltip()
                    {
                        Content="Wall Corner1"
                    },
                    Constraints = (NodeConstraints.Default | NodeConstraints.Tooltip),
                    Shape = new PathShape()
                    {
                        Data = "M0 100L100 100L100 0"
                    }
                },
                new Node()
                {
            ...
            BedRoomSymbols = new DiagramObjectCollection<NodeBase>()
            {
                new Node()
                {
                    ID = "Doublebed",
                ...
                new Node()
                {
                    ...
                    Shape = new PathShape()
                    {
                        Data = "M1 20H29M1 2V54C1 54.5523 1.44772 55 2 55H28C28.5523 55 29 54.5523 29 54V2C29 1.44771 28.5523 1 28 1H2C1.44772 1 1 1.44772 1 2ZM9 8V14C9 14.5523 9.44772 15 10 15H20C20.5523 15 21 14.5523 21 14V8C21 7.44772 20.5523 7 20 7H10C9.44772 7 9 7.44772 9 8Z"
                    }
                },
                new Node()
                {
                ...
                new Node()
                {
                    ...
                    Shape = new PathShape()
                    {
                        Data = "M113 9V1H1V9M113 9H1M113 9V29H1V9M4 12H11V25H4V12ZM13 12H20V25H13V12ZM22 12H29V25H22V12ZM31 12H38V25H31V12ZM40 12H47V25H40V12ZM49 12H56V25H49V12ZM58 12H65V25H58V12ZM67 12H74V25H67V12ZM76 12H83V25H76V12ZM85 12H92V25H85V12ZM94 12H101V25H94V12ZM103 12H110V25H103V12Z"
                    }
                },
                new Node()
                {
                ...
                new Node()
                {
                    ...
                    Shape = new PathShape()
                    {
                        Data = "M1 3C1 1.89543 1.89543 1 3 1L68 1C69.1046 1 70 1.89543 70 3V48C70 49.1046 69.1046 50 68 50H3C1.89543 50 1 49.1046 1 48L1 3Z M1 12H70V39H1L1 12Z M1 15H70V36H1L1 15Z"
                    }
                },
                new Node()
                {
            ...
            LivingRoomSymbols = new DiagramObjectCollection<NodeBase>()
            {
                new Node()
                {
                    ID = "TV",
                    ...
                    Shape = new PathShape()
                    {
                        Data = "M55 23H4C2.34315 23 1 24.3431 1 26V40H58V26C58 24.3431 56.6569 23 55 23ZM55 23L48.1968 4.29128C47.4783 2.31534 45.6004 1 43.4979 1H16.5021C14.3996 1 12.5217 2.31533 11.8032 4.29128L5 23H55ZM16 1V23M25 1V23M34 1V23M43 1V23M1 36.5H58"
                    }
                },
                new Node()
                {
                    ...
                    Shape = new PathShape()
                    {
                        Data = "M1 15H92M1 15V20H92V15M1 15V10H92V15M79 7L85 1M79 20L85 26M14 7L8 1M14 20L8 26M37 2V7M39 2V7M41 2V7M43 2V7M45 2V7M47 2V7M49 2V7M51 2V7M53 2V7M55 2V7M23 2H70L76 7H17L23 2ZM5 7H88V10H5V7Z"
                    }
                },
                new Node()
                {
                    ...
                    Shape = new PathShape()
                    {
                        Data = "M1 14H92M1 14V19H92V14M1 14V9H92V14M37 1V6M39 1V6M41 1V6M43 1V6M45 1V6M47 1V6M49 1V6M51 1V6M53 1V6M55 1V6M23 1H70L76 6H17L23 1ZM5 6H88V9H5V6Z"
                    }
                },
                new Node()
                {
                ...
                new Node()
                {
                    ...
                    Shape = new PathShape()
                    {
                        Data = "M58 31C58 46.464 45.6878 59 30.5 59C15.3122 59 3 46.464 3 31C3 15.536 15.3122 3 30.5 3C45.6878 3 58 15.536 58 31Z  M29 59V61H25V59H29Z M29 1V3H25V1L29 1Z M36 59V61H32V59H36Z M36 1V3H32V1L36 1Z M3 29H1L1 25H3L3 29Z M60 29H58V25H60V29Z M3 36H1L1 32H3L3 36Z M60 36H58V32H60V36Z"
                    }
                },
                new Node()
                {
                ...
                new Node()
                {
                    ...
                    Shape = new PathShape()
                    {
                        Data = "M14.3536 14.6464L77.3536 77.6464M77.3536 14.3536L14.3536 77.3536M14 14H78V78H14V14ZM11 11H81V81H11V11ZM9 89H1V1H91V89H83V9H9V89Z"
                    }
                },
            };
            BathRoomSymbols = new DiagramObjectCollection<NodeBase>()
            {
                new Node()
                {
                    ID = "Toilet1",
